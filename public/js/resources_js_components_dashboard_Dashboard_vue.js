        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _this.axios.get('/api/dashboard/data').then(function (response) {
                  var _response$data$data = response.data.data,
                      user_today = _response$data$data.user_today,
                      user_weekly = _response$data$data.user_weekly,
                      user_monthly = _response$data$data.user_monthly,
                      applicant_today = _response$data$data.applicant_today,
                      applicant_weekly = _response$data$data.applicant_weekly,
                      applicant_monthly = _response$data$data.applicant_monthly;
                  _this.dashboard.user_today = user_today;
                  _this.dashboard.user_weekly = user_weekly;
                  _this.dashboard.user_monthly = user_monthly;
                  _this.dashboard.applicant_today = applicant_today;
                  _this.dashboard.applicant_weekly = applicant_weekly;
                  _this.dashboard.applicant_monthly = applicant_monthly;
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-xl-4 col-sm-6 mb-xl-0 mb-4" }, [
      _c(
        "div",
        {
          staticClass: "card",
          staticStyle: {
            background: "rgb(30, 177, 20)",
              ...
              _c("div", { staticClass: "col-8" }, [
                _c("div", { staticClass: "numbers" }, [
                  ...
                  _c("h5", { staticClass: "font-weight-bolder" }, [
                    _vm._v(
                      "\n                      " +
                        _vm._s(_vm.dashboard.user_today) +
                        "\n                    "
                    )
                  ])
                ])
              ...
              _c("div", { staticClass: "col-8" }, [
                _c("div", { staticClass: "numbers" }, [
                  _c(
                    ...
                    {
                      staticClass:
                        "text-sm mb-0 text-uppercase font-weight-bold"
                    },
                    [_vm._v("Total Registered Users This (Week)")]
                  ),
                  _vm._v(" "),
                  _c("h5", { staticClass: "font-weight-bolder" }, [
                    _vm._v(
                      "\n                          " +
                        _vm._s(_vm.dashboard.user_weekly) +
                        "\n                        "
                    )
                  ])
                ])
              ...
              _c("div", { staticClass: "col-8" }, [
                _c("div", { staticClass: "numbers" }, [
                  _c(
                    ...
                    [_vm._v("Total Registered Users This (Month)")]
                  ),
                  _vm._v(" "),
                  _c("h5", { staticClass: "font-weight-bolder" }, [
                    _vm._v(
                      "\n                              " +
                        _vm._s(_vm.dashboard.user_monthly) +
                        "\n                            "
                    )
                  ])
                ])
    ...
    _c(
      "div",
      {
        staticClass: "col-xl-4 col-sm-6 mb-xl-0 mb-4",
                ...
                _c("div", { staticClass: "col-8" }, [
                  _c("div", { staticClass: "numbers" }, [
                    ...
                    _c("h5", { staticClass: "font-weight-bolder" }, [
                      _vm._v(
                        "\n                                  " +
                          _vm._s(_vm.dashboard.applicant_today) +
                          "\n                                "
                      )
                    ])
                  ])
                ...
                _c("div", { staticClass: "col-8" }, [
                  _c("div", { staticClass: "numbers" }, [
                    ...
                    _c("h5", { staticClass: "font-weight-bolder" }, [
                      _vm._v(
                        "\n                                      " +
                          _vm._s(_vm.dashboard.applicant_weekly) +
                          "\n                                    "
                      )
                    ])
                  ])
                ...
                _c("div", { staticClass: "col-8" }, [
                  _c("div", { staticClass: "numbers" }, [
                    ...
                    _c("h5", { staticClass: "font-weight-bolder" }, [
                      _vm._v(
                        "\n                                          " +
                          _vm._s(_vm.dashboard.applicant_monthly) +
                          "\n                                        "
                      )
                    ])
                  ])
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "p",
      { staticClass: "text-sm mb-0 text-uppercase font-weight-bold" },
      [_vm._v("Total Registered Users"), _c("br"), _vm._v(" (Today)")]
    )
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c(
      "p",
      { staticClass: "text-sm mb-0 text-uppercase font-weight-bold" },
      [_vm._v("Total Applications "), _c("br"), _vm._v("(Today)")]
    )
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c(
      "p",
      { staticClass: "text-sm mb-0 text-uppercase font-weight-bold" },
      [_vm._v("Total Applications This "), _c("br"), _vm._v("(Week)")]
    )
  },
  function() {
    var _vm = this
  ...
  function() {
    ...
    return _c(
      "p",
      { staticClass: "text-sm mb-0 text-uppercase font-weight-bold" },
      [_vm._v("Total Applications This "), _c("br"), _vm._v("(Month)")]
    )
  },
  function() {
    var _vm = this
